...
#Ensure the working directory is in the same folder as 'assembler.py'
...
try:
    ...
    print("File not found. Make sure your ARM64 assembly code is named 'demo.s' and is in the same directory as your program. \n")
